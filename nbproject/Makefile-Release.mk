...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/pool: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/pool ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/src/AppPool.o: src/AppPool.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/AppPool.o src/AppPool.cpp

${OBJECTDIR}/src/CtxGameOver.o: src/CtxGameOver.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CtxGameOver.o src/CtxGameOver.cpp

${OBJECTDIR}/src/CtxOption.o: src/CtxOption.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CtxOption.o src/CtxOption.cpp

${OBJECTDIR}/src/CtxPool.o: src/CtxPool.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CtxPool.o src/CtxPool.cpp
